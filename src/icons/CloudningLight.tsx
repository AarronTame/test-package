...
const CloudningLight: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={pathsByWeight} />);

CloudningLight.displayName = "CloudningLight";

export default CloudningLight;
