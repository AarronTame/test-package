...
const pathsByWeight = new Map<IconWeight, JSX.Element>([
  ...
  [
    "duotone",
    <>
      <path d="M160,56H96l32-32ZM128,232l32-32H96Z" opacity="0.2"/><path d="M160,192H136V64h24a8,8,0,0,0,5.66-13.66l-32-32a8,8,0,0,0-11.32,0l-32,32A8,8,0,0,0,96,64h24V192H96a8,8,0,0,0-5.66,13.66l32,32a8,8,0,0,0,11.32,0l32-32A8,8,0,0,0,160,192ZM128,35.31,140.69,48H115.31Zm0,185.38L115.31,208h25.38Z"/>
    </>
  ],
  [
    "fill",
...
const ArrowsVertical: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={pathsByWeight} />);
