...
const pathsByWeight = new Map<IconWeight, JSX.Element>([
  ...
  [
    "duotone",
    <>
      <path d="M232,56V200a16,16,0,0,1-16,16H40a16,16,0,0,1-16-16V56A16,16,0,0,1,40,40H216A16,16,0,0,1,232,56Z" opacity="0.2"/><path d="M208,88a8,8,0,0,1-8,8H176v24h16a8,8,0,0,1,0,16H176v32a8,8,0,0,1-16,0V88a8,8,0,0,1,8-8h32A8,8,0,0,1,208,88Zm-72-8a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,136,80Zm-32,40H88a8,8,0,0,0,0,16h8v8a16,16,0,0,1-32,0V112a16,16,0,0,1,27.93-10.67,8,8,0,1,0,11.92-10.66A32,32,0,0,0,48,112v32a32,32,0,0,0,64,0V128A8,8,0,0,0,104,120Z"/>
    </>
  ],
  [
    "fill",
...
const Gif: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={pathsByWeight} />);
