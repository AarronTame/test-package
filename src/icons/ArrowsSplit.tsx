...
const pathsByWeight = new Map<IconWeight, JSX.Element>([
  ...
  [
    "duotone",
    <>
      <path d="M32,184H96L64,216Zm128,0,32,32,32-32Z" opacity="0.2"/><path d="M231.39,180.94A8,8,0,0,0,224,176H200V136a8,8,0,0,0-2.34-5.66L136,68.69V24a8,8,0,0,0-16,0V68.69L58.34,130.34A8,8,0,0,0,56,136v40H32a8,8,0,0,0-5.66,13.66l32,32a8,8,0,0,0,11.32,0l32-32A8,8,0,0,0,96,176H72V139.31l56-56,56,56V176H160a8,8,0,0,0-5.66,13.66l32,32a8,8,0,0,0,11.32,0l32-32A8,8,0,0,0,231.39,180.94ZM64,204.69,51.31,192H76.69Zm128,0L179.31,192h25.38Z"/>
    </>
  ],
  [
    "fill",
...
const ArrowsSplit: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={pathsByWeight} />);
