...
const pathsByWeight = new Map<IconWeight, JSX.Element>([
  ...
  [
    "duotone",
    <>
      <path d="M216,64V176a8,8,0,0,1-8,8H40V64Z" opacity="0.2"/><path d="M32,64a8,8,0,0,1,8-8H216a8,8,0,0,1,0,16H40A8,8,0,0,1,32,64Zm8,48H168a8,8,0,0,0,0-16H40a8,8,0,0,0,0,16Zm176,24H40a8,8,0,0,0,0,16H216a8,8,0,0,0,0-16Zm-48,40H40a8,8,0,0,0,0,16H168a8,8,0,0,0,0-16Z"/>
    </>
  ],
  [
    "fill",
...
const TextAlignLeft: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={pathsByWeight} />);
