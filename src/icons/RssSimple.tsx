...
const pathsByWeight = new Map<IconWeight, JSX.Element>([
  ...
  [
    "duotone",
    <>
      <path d="M208,200H56V48A152,152,0,0,1,208,200Z" opacity="0.2"/><path d="M216,200a8,8,0,0,1-16,0c0-79.4-64.6-144-144-144a8,8,0,0,1,0-16C144.22,40,216,111.78,216,200ZM56,112a8,8,0,0,0,0,16,72.08,72.08,0,0,1,72,72,8,8,0,0,0,16,0A88.1,88.1,0,0,0,56,112Zm4,72a12,12,0,1,0,12,12A12,12,0,0,0,60,184Z"/>
    </>
  ],
  [
    "fill",
...
const RssSimple: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={pathsByWeight} />);
