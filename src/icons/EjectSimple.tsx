...
const pathsByWeight = new Map<IconWeight, JSX.Element>([
  ...
  [
    "duotone",
    <>
      <path d="M215.92,160H40.08a8.1,8.1,0,0,1-6.26-13.2L115.48,46a16.1,16.1,0,0,1,25,0L222.18,146.8A8.1,8.1,0,0,1,215.92,160Z" opacity="0.2"/><path d="M232,208a8,8,0,0,1-8,8H32a8,8,0,1,1,0-16H224A8,8,0,0,1,232,208ZM25.59,158.84a16,16,0,0,1,2-17.07L109.26,40.94a24.11,24.11,0,0,1,37.48,0l81.65,100.83A16.1,16.1,0,0,1,215.91,168H40.09A16,16,0,0,1,25.59,158.84ZM40,151.91s0,.09.08.11l175.83,0s.08-.09.08-.13L134.3,51a8.1,8.1,0,0,0-12.6,0L40,151.84A.28.28,0,0,0,40,151.91Z"/>
    </>
  ],
  [
    "fill",
...
const EjectSimple: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={pathsByWeight} />);
